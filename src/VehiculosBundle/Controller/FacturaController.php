...
use VehiculosBundle\Entity\Factura;
use VehiculosBundle\Form\FacturaType;
...
class FacturaController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $entities = $em->getRepository('VehiculosBundle:Factura')->findAll();
        ...
        return $this->render('VehiculosBundle:Factura:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            $this->get('session')->getFlashBag()->add(
                'success', 'Factura creado correctamente.'
            );

            return $this->redirect($this->generateUrl('factura_show', array('id' => $entity->getId())));
        }

        return $this->render('VehiculosBundle:Factura:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('VehiculosBundle:Factura')->find($id);
        ...
        return $this->render('VehiculosBundle:Factura:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('VehiculosBundle:Factura:edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            $this->get('session')->getFlashBag()->add(
                'success', 'Factura actualizado correctamente.'
            );
