...
class CodigoModeloController extends Controller {
	...
	public function indexAction( Request $request ) {
		...
		$entities = $em->getRepository( 'VehiculosBundle:CodigoModelo' )->findAll();
		...
		return $this->render( 'VehiculosBundle:CodigoModelo:index.html.twig',
			array(
				'entities' => $entities,
			) );
	}
	...
	public function createAction( Request $request ) {
		...
		if ( $form->isValid() ) {
			...
			$this->get( 'session' )->getFlashBag()->add(
				'success',
				'CodigoModelo creado correctamente.'
			);
...
//            return $this->redirect();
		...
		return $this->render( 'VehiculosBundle:CodigoModelo:new.html.twig',
			array(
				'entity' => $entity,
	...
	private function createCreateForm( CodigoModelo $entity ) {
		$form = $this->createForm( new CodigoModeloType(),
			$entity,
			array(
	...
	public function showAction( $id ) {
		...
		return $this->render( 'VehiculosBundle:CodigoModelo:show.html.twig',
			array(
				'entity'      => $entity,
	...
	public function editAction( $id ) {
		...
		return $this->render( 'VehiculosBundle:CodigoModelo:edit.html.twig',
			array(
				'entity'      => $entity,
	...
	public function updateAction( Request $request, $id ) {
		...
		if ( $editForm->isValid() ) {
			...
			$this->get( 'session' )->getFlashBag()->add(
				'success',
				'CodigoModelo actualizado correctamente.'
			);
