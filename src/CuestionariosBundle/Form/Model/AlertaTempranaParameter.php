...
class AlertaTempranaParameter {
	...
	public function __construct( $parameters, EntityManager $entityManager, $edit = false, $extraParams = array() ) {
		if ( $edit == false ) {
	...
	private function buildField( $entityManager, $value ) {
		/* @var $value \CuestionariosBundle\Entity\EncuestaPregunta */
		$name = $value->getId();
