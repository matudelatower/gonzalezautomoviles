...
class EncuestaController extends Controller {
    ...
    public function indexAction(Request $request) {
        ...
        return $this->render('CuestionariosBundle:Encuesta:index.html.twig', array(
                    'entities' => $entities,
        ));
    }
    ...
    public function createAction(Request $request) {
        ...
        return $this->render('CuestionariosBundle:Encuesta:new.html.twig', array(
                    'entity' => $entity,
    ...
    public function showAction($id) {
        ...
        return $this->render('CuestionariosBundle:Encuesta:show.html.twig', array(
                    'entity' => $entity,
    ...
    public function editAction($id) {
        ...
        return $this->render('CuestionariosBundle:Encuesta:edit.html.twig', array(
                    'entity' => $entity,
    ...
    public function crearAlertaTempranaAction(Request $request, $vehiculoId) {
        ...
        if ($request->getMethod() == 'POST') {
            $alertaTempranaCabecera = $em->getRepository('CuestionariosBundle:EncuestaResultadoCabecera')->findOneByVehiculo($vehiculo);

            if (!$alertaTempranaCabecera) {
            ...
            return $this->redirectToRoute('app_bloquear_pantalla', array(
                        'vehiculoId' => $vehiculoId,
            ));
        }

        return $this->render('CuestionariosBundle:Encuesta:formAlertaTemprana.html.twig', array(
                    'vehiculo' => $vehiculo,
                    'preguntas' => $preguntas,
                    'encuesta' => $encuesta,
                    'linkLogo' => false,
...
//		$opcionesPregunta = $em->getRepository( 'CuestionariosBundle:EncuestaOpcionRespuesta' )->findByEncuestaPregunta( $pregunta );
        ...
        return $this->render(
                        'CuestionariosBundle:Cuestionario:campos.html.twig', array(
                    'form' => $form->createView(),
                        )
        );
    }
    ...
    public function pdfVerEncuestaAltaTempranaAction($vehiculoId) {
        ...
        $encuestaResultadoRespuesta = $em->getRepository('CuestionariosBundle:EncuestaResultadoRespuesta')->findByEncuestaResultadoCabeceraOrdenado($encuestaResultadoCabecera);


        $title = 'Encuesta Alerta Temprana';

        $html = $this->renderView(
                'CuestionariosBundle:Encuesta:alertaTemprana.pdf.twig', array(
            'title' => $title,
