...
use VehiculosBundle\Form\Filter\ReporteVehiculosAsignadosAClienteFilterType;
...
//        $entities = $managerEncuestas->getAutosVendidosPorVendedor($vendedor, $fechaDesde, $fechaHasta);
	...
	public function excelReporteVehiculosAsignadosAReventaAction( Request $request ) {
        ...
        /*
         * devuelve lso vehiculos que esten asignados a algun cliente
         */
        public function indexReporteVehiculosAsignadosAClienteAction( Request $request ) {
		$form = $this->createForm( new ReporteVehiculosAsignadosAClienteFilterType());
...
//			if ( $formData['cliente'] ) {
				...
				$entities = $reportesManager->getVehiculosAsignadosACliente( $formData );
//			}
		}
		$cantidadRegistros = count( $entities );
		$paginator         = $this->get( 'knp_paginator' );
		...
		return $this->render( 'VehiculosBundle:Reporte:reporteVehiculosAsignadosACliente.html.twig',
			array(
				'entities'          => $entities,
				'form'              => $form->createView(),
				'cantidadRegistros' => $cantidadRegistros,
	...
	public function pdfReporteVehiculosAsignadosAClienteAction( Request $request ) {
		$form = $this->createForm( new ReporteVehiculosAsignadosAClienteFilterType() );
...
//			}
		...
		$title = 'Reporte de Vehículos Asignados a Cliente';

		$html = $this->renderView(
			'VehiculosBundle:Reporte:reporteVehiculosAsignadosACliente.pdf.twig',
			array(
				'entities' => $entities,
				'title'    => $title,
				'datos'  => $formData
	...
	public function excelReporteVehiculosAsignadosAClienteAction( Request $request ) {
		$form = $this->createForm( new ReporteVehiculosAsignadosAClienteFilterType());
...
//			}
		...
		$filename = "reporte_vehiculos_asignados_a_cliente.xls";


		$exportExcel = $this->get( 'excel.tool' );
		$exportExcel->setTitle( 'Vehiculos Asignados a Cliente' );
		$exportExcel->setDescripcion( 'Listado de Vehiculos Asignados a Cliente' );

		$response = $exportExcel->buildSheetReporteVehiculosAsignadosACliente( $entities );
